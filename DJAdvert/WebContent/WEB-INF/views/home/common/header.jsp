...
<body>
	...
	<div class="shop_hd">
		...
		<div class="shop_hd_topNav">
			<div class="shop_hd_topNav_all">
				...
				<div class="shop_hd_topNav_all_left">
					<p>您好，欢迎来到<b><a href="/DJAdvert">东京找物商城</a></b>
		...
		<div class="shop_hd_header">
			<div class="shop_hd_header_logo"><h1 class="logo"><a href="/DJAdvert"><img src="../resources/home/images/logo1.png" alt="ShopCZ" /></a><span>优选网</span></h1></div>
			    ...
			    <div class="search_form">
			    	<form method="post" action="../product/search">
			    		<div class="search_formstyle">
			    			...
			    			<input type="submit" class="search_form_sub" name="secrch_submit" value="搜索" title="搜索" />
			    		</div>
			    	</form>
			    </div>
                            <div class="clear"></div>
		...
		<div class="shop_hd_menu">
			...
			<ul class="shop_hd_menu_nav">
				<li class="${currentHome }link"><a href="/DJAdvert"><span>首页</span></a></li>
